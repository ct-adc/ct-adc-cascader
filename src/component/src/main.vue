...
import ElInput from 'component/input';
import Popper from 'component/utils/vue-popper';
import Clickoutside from 'component/utils/clickoutside';
import emitter from 'component/mixins/emitter';
import Locale from 'component/mixins/locale';
import { t } from 'component/locale';
import debounce from 'throttle-debounce/debounce';
import { generateId, escapeRegexpString } from 'component/utils/util';
...
<style>
@import '~component/style/cascader.css';
</style>
